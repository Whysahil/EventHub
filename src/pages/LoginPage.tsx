  ...
  return (
    <div className="flex min-h-screen relative overflow-hidden bg-[#0a0a0a] font-sans">
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#0a0a0a] flex-col items-center justify-center overflow-hidden border-r border-white/5">
         ...
         <div className="absolute top-[-20%] left-[-10%] w-[80%] h-[80%] bg-indigo-500/20 rounded-full blur-[120px] pointer-events-none opacity-50 mix-blend-screen"></div>
         <div className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-purple-500/10 rounded-full blur-[100px] pointer-events-none opacity-40 mix-blend-screen"></div>
         ...
         >
            <div className="mb-12">
               <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[10px] font-bold uppercase tracking-widest text-indigo-300 mb-6 font-mono">
                  Authentication
               </div>
               <h2 className="text-5xl font-bold text-white mb-6 tracking-tighter leading-tight bg-clip-text text-transparent bg-gradient-to-br from-white to-gray-500">
                 The Premier Network for Indian Builders.
               </h2>
               <p className="text-gray-400 font-light text-lg tracking-wide leading-relaxed">
                 Join thousands of creators, founders, and industry leaders accessing exclusive events across the subcontinent.
               </p>
            </div>
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/10 group cursor-pointer aspect-video bg-gray-900">
               <Image src="https://images.unsplash.com/photo-1540575467063-178a50c2df87?auto=format&fit=crop&q=80&w=1200" containerClassName="absolute inset-0 w-full h-full" className="group-hover:scale-105 transition-transform duration-1000 opacity-80" alt="Event" />
               ...
               <div className="absolute bottom-6 left-6 right-6 flex items-center gap-4">
                  ...
                  <div>
                     <p className="text-white font-semibold text-sm">Startup Mahakumbh Aftermovie</p>
                     <p className="text-gray-400 text-xs font-medium uppercase tracking-widest mt-1">10M+ Views</p>
                  </div>
               </div>
            </div>
         </motion.div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        ...
        >
          ...
          <div className="mb-10">
            <h1 className="text-4xl font-bold tracking-tighter text-white mb-3 bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">Welcome back.</h1>
            <p className="text-base text-gray-400 font-light tracking-wide">Sign in to manage and book your experiences.</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <p className="text-center text-sm font-medium text-gray-400 mt-10">
                Don't have an account? <Link to="/register" className="text-white hover:text-indigo-400 ml-1 transition-colors underline underline-offset-4">Sign up</Link>
              </p>
          </form>
        </motion.div>
      </div>
